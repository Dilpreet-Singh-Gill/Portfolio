...
const ProjectCard = ({ title, category, description, techStack, period, index }) => {
  return (
    <div className="group relative bg-card rounded-2xl overflow-hidden hover-lift cursor-pointer border border-border hover:border-primary/50 transition-all duration-500">
